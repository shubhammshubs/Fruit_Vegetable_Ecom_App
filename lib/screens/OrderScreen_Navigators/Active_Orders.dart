                ...
                if (constraints.maxWidth > 600) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ActiveOrderCard(
                        id: orderData[index]['trans_id'].toString(),
                        orderDate: orderData[index]['product_title'].toString(),
                        payment: orderData[index]['price'].toString(),
                        orderStatus: 'Order Placed',
                      );
                    },
                  );
                  ...
                  return ListView(
                    ...
                    children: orderData.map(
                          (data) => ActiveOrderCard(
                        id: data['trans_id'].toString(),
                        orderDate: data['product_title'].toString(),
                        payment: data['price'].toString(),
                        orderStatus: 'Order Placed',
                      ),
                    ).toList(),
                  );
